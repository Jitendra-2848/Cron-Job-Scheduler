      ...
      <div className="px-4 sm:px-6 py-4 sm:py-5 border-b border-slate-200 dark:border-slate-800 flex items-center justify-between">
        <div>
          ...
          <p className="text-[11px] sm:text-xs text-slate-500 dark:text-slate-400 mt-0.5">
            Monitor your latest scheduled job configurations
          </p>
        </div>

        <button
          onClick={() => navigate('/cron-jobs')}
          className="flex items-center gap-1 text-xs font-semibold text-emerald-600 dark:text-emerald-400 hover:text-emerald-700 dark:hover:text-emerald-300 transition-colors shrink-0"
        >
          View all
          ...
          >
            ...
            <div className="flex items-center justify-between pt-1 text-[11px]">
              ...
              <button
                ...
                className="flex items-center gap-1 px-2.5 py-1 rounded-lg bg-emerald-50 dark:bg-emerald-950/60 text-emerald-600 dark:text-emerald-400 font-semibold text-[11px]"
              >
